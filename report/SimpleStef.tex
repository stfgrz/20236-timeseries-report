...
\definecolor{sgcoral}{RGB}{255, 111, 97}        % Define a new orange/red/pinkish color
...
% Exercise with a Dandelion bar (shares counter with Example)
\theoremstyle{theorem}
...
% Unnumbered Assumption with no background, just a left border
\theoremstyle{theorem}
\newtheorem{assumption}{Assumption}
\tcolorboxenvironment{assumption}{
  boxrule=0pt,
  boxsep=0pt,
  blanker, % This removes the background and outer frame entirely
  borderline west={1pt}{0pt}{sgcoral}, % The thin solid line on the left
  before skip=10pt,
  after skip=10pt,
  sharp corners,
  left=5pt, % Keeps the text from bumping into the line
  right=5pt,
  breakable,
}
